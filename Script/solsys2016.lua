...
th1 = -0.342
h:set_text('Mercury')
par1:set_text('Radius: 2,440km  Mass: 3.285x0^23kg  Mean orbital radius: 57.91x0^6km (0.387AU)  Orbital period: 7.601x0^6s (88.0 days)')
...
th1 = -1.48
h:set_text('Venus')
par1:set_text('Radius: 6,052km  Mass: 4.867x0^24kg  Mean orbital radius: 108.2x0^6km (0.723AU)  Orbital period: 1.941x0^7s (224.7 days)')
...
th1 = 0.714
h:set_text("Earth")
par1:set_text('Radius: 6,371km  Mass: 5.972x0^24kg  Mean orbital radius: 149.6x0^6km (1AU)  Orbital period: 3.156x0^7s (365.24 days)')
...
th1 = -1.51
h:set_text('Moon')
par1:set_text('Natural satellite of Earth  Radius: 1,737km  Mass: 7.348x0^22kg  Mean orbital radius: 3.8x0^5km  Orbital period: 2.317x0^6s (27.32 days)')
...
th1 = -0.360
h:set_text('Mars')
par1:set_text('Radius: 3,390km  Mass: 6.39x0^23kg  Mean orbital radius: 227.9x0^6km (1.52AU)  Orbital period: 5.94x0^7s (687.0 days)')
...
th1 = 0.168
h:set_text('Phobos')
par1:set_text('Natural satellite of Mars    Mean radius: 11.27km  Mass: 1.066x0^16kg  Mean orbital radius: 9,374km  Orbital period: 2.755x0^4s (0.32 days)')
...
th1 = -0.373
h:set_text('Deimos')
par1:set_text('Natural satellite of Mars    Mean radius: 6.2km  Mass: 1.48x0^15kg  Mean orbital radius: 23,463km  Orbital period: 1.091x0^5s (1.263 days)')
...
th1 = -1.56
h:set_text('Vesta')
par1:set_text('Asteriod belt object  Mean radius: 262.5km  Mass: 2.589x0^20kg  Mean orbital radius: 3.533x0^8km (2.3618AU)  Orbital period: 1.145x0^8s (3.63 years)')
...
th1 = 3.048
h:set_text('Jupiter')
par1:set_text('Radius: 69,911km  Mass: 1.898x0^27kg  Mean orbital radius: 778.5x0^6km (5.20AU)  Orbital period: 3.743x0^8s (11.86 years)')
...
th1 = -1.18
h:set_text('Io')
par1:set_text('Natural satellite of Jupiter  Radius: 1,821.6km  Mass: 8.932x0^22kg  Mean orbital radius: 421,700km  Orbital period: 1.529x0^5s (1.769 days)')
...
th1 = 3.105
h:set_text('Europa')
par1:set_text('Natural satellite of Jupiter  Radius: 1,560.8km  Mass: 4.800x0^22kg  Mean orbital radius: 670,900km  Orbital period: 3.068x0^5s (3.551 days)')
...
th1 = -1.47
h:set_text('Ganymede')
par1:set_text('Natural satellite of Jupiter  Radius: 2,634.1km  Mass: 1.482x0^23kg  Mean orbital radius: 1.0703x0^6km  Orbital period: 6.182x0^5s (7.155 days)')
...
th1 = -1.41
h:set_text('Callisto')
par1:set_text('Natural satellite of Jupiter  Radius: 2,410.3km  Mass: 1.076x0^23kg  Mean orbital radius: 1.883x0^6km  Orbital period: 1.442x0^6s (16.690 days)')
...
th1 = 0.467
h:set_text('Saturn')
par1:set_text('Radius: 58,232km  Mass:  5.683x0^26kg  Mean orbital radius: 1.433x0^9km (9.58AU)  Orbital period: 9.2960x0^8s (29.46 years)')
...
th1 = 0.623
h:set_text('Mimas')
par1:set_text('Natural satellite of Saturn  Radius: 198.2km  Mass:  3.7493x0^19kg  Mean orbital radius: 185,320km  Orbital period: 81389s (0.942 days)')
...
par1:set_text('Natural satellite of Saturn  Radius: 252.1km  Mass: 1.0802x0^20kg  Mean orbital radius: 237,912km  Orbital period: 1.184x0^5s (1.370 days)')
...
th1 = -1.28
h:set_text('Tethys')
par1:set_text('Natural satellite of Saturn  Radius: 531.1km  Mass: 6.1745x0^20kg  Mean orbital radius: 294,572km  Orbital period: 1.631x0^5s (1.888 days)')
...
th1 = 0.276
h:set_text('Dione')
par1:set_text('Natural satellite of Saturn  Radius: 561.4km  Mass: 1.0955x0^21kg  Mean orbital radius: 377,336km  Orbital period: 2.365x0^5s (2.737 days)')
...
th1 = -1.10
h:set_text('Rhea')
par1:set_text('Natural satellite of Saturn  Radius: 763.8km  Mass: 2.306518x0^21kg  Mean orbital radius: 527,067km  Orbital period: 3.904x0^5s (4.518 days)')
...
th1 = -0.60
h:set_text('Titan')
par1:set_text('Natural satellite of Saturn  Radius: 2575.5km  Mass: 1.3452x0^23kg  Mean orbital radius: 1.2217x0^6km  Orbital period: 1.378x0^6s (15.945 days)')
...
th1 = 0.376
h:set_text('Iapetus')
par1:set_text('Natural satellite of Saturn  Radius: 734.5km  Mass: 1.8056x0^21kg  Mean orbital radius: 3.5601x0^6km  Orbital period: 6.853x0^6s (79.322 days)')
...
th1 = 0.534
h:set_text('Uranus')
par1:set_text('Radius: 25,362km  Mass: 8.681x0^25kg  Mean orbital radius: 2.877x0^9km (19.23AU)  Orbital period: 2.6515x0^9s (84.0205 years)')
...
th1 = -0.617
h:set_text('Miranda')
par1:set_text('Natural satellite of Uranus  Radius: 235.8km  Mass: 6.59x0^19kg  Mean orbital radius: 129,840km  Orbital period: 1.2212x0^5s (1.413 days)')
...
th1 = -0.021
h:set_text('Ariel')
par1:set_text('Natural satellite of Uranus  Radius: 578.9km  Mass: 1.353x0^21kg  Mean orbital radius: 190,900km  Orbital period: 2.17728x0^5s (2.520 days)')
...
th1 = 0.622
h:set_text('Umbriel')
par1:set_text('Natural satellite of Uranus  Radius: 584.7km  Mass: 1.172x0^21kg  Mean orbital radius: 265,967km  Orbital period: 3.5804x0^5s (4.144 days)')
...
th1 = -1.50
h:set_text('Titania')
par1:set_text('Natural satellite of Uranus  Radius: 788.4km  Mass: 3.527x0^21kg  Mean orbital radius: 436,282km  Orbital period: 7.522x0^5s (8.706 days)')
...
th1 = -1.56
h:set_text('Oberon')
par1:set_text('Natural satellite of Uranus  Radius: 761.4km  Mass: 3.014x0^21kg  Mean orbital radius: 583,416km  Orbital period: 1.163x0^6s (13.463 days)')
...
th1 = -1.58
h:set_text('Neptune')
par1:set_text('Radius: 24,622km  Mass: 1.024x0^26kg  Mean orbital radius: 4.498x0^9km (30.07AU)  Orbital period: 5.1997x0^9s (164.8 years)')
...
th1 = 0.617
h:set_text('Triton')
par1:set_text('Natural satellite of Neptune  Radius: 1353.4km  Mass: 2.14x0^22kg  Mean orbital radius: 354,757km  Orbital period: -5.0776x0^5s (-5.877 days) - retrograde')
...
th1 = 0.001
h:set_text('Proteus')
par1:set_text('Natural satellite of Neptune  Radius: 210km  Mass: 4.4x0^19kg  Mean orbital radius: 117,647km  Orbital period: 9.6968x0^4s (1.12231477 days)')
...
th1 = -1.60
h:set_text('Nereid')
par1:set_text('Natural satellite of Neptune  Radius: 170km  Mean orbital radius: 5.5141x0^6km  Orbital period: 3.1115x0^7s (360.1362 days)')
...
th1 = -1.57
h:set_text('Earth')
par1:set_text("This concludes the journey through SpaceXpanse Metaverse's solar system.    Back to the home planet.")
oapi.set_cameratarget(oapi.get_objhandle('Earth'))
oapi.set_cameramode({mode='ground',ref='Earth',lng=lng0, lat=lat0, alt=alt0, phi=ph0, tht=th0, alt_above_ground=0})
oapi.set_cameraaperture(10*RAD)
while t1 < 720 do
...
par1:set_text("This concludes the journey through SpaceXpanse Metaverse's solar system.    Let's finish with a view towards our home planet.")
oapi.set_cameratarget(oapi.get_objhandle('Moon'))
oapi.set_cameramode({mode='ground',ref='Moon',lng=lng0, lat=lat0, alt=alt0, phi=ph0, tht=th0, alt_above_ground=0})
